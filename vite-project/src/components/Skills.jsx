...
function Skills() {
  return (
    ...
    >
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-black/70 via-transparent via-50% to-black/70 pointer-events-none"></div>
            ...
            <div className="grid grid-cols-4 gap-8">
                ...
                <div className="col-start-2 col-span-1 p-6 border border-white/20 rounded-xl bg-white/5 backdrop-blur-xs">
