...
function Achivements() {
    ...
    return (
        <div
            id="achivements"
            className="relative min-h-screen bg-black bg-center bg-no-repeat bg-cover flex flex-col justify-center items-center"
            style={{ backgroundImage: `url(${bg})` }}
        >

            {/* vignette */}
            <div className="absolute inset-0 bg-gradient-to-b from-black/100 via-transparent via-50% to-black/100 pointer-events-none z-0"></div>
